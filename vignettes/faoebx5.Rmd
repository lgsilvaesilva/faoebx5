...
```{r credentials, eval=TRUE, include=TRUE, message=FALSE}
library('faoebx5')
library('dplyr')
SetEBXCredentials()
```
...
```{r get_codelists, eval=TRUE, include=TRUE}
...
```{r read_codelists, eval=TRUE, include=TRUE}
...
```{r new_cl, eval=TRUE, include=TRUE}
...
```{r insert_codelist, eval=TRUE, include=TRUE}
...
```{r update_codelist, eval=TRUE, include=TRUE}
